...
/** Presentation-only Phase 13 contract. Technical result schema remains 13. */
final class Phase13Contract {
    static final int UX_SCHEMA_VERSION = 1;
    ...
    static final boolean METHODOLOGY_CHANGED = false;
