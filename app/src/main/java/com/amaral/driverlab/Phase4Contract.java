...
final class Phase4Contract {
    ...
    static final String LIMITATION =
            "O histórico reflete somente suítes presentes no aparelho. Rankings exigem o mesmo "
                    ...
                    + "v3 e datasets públicos v3 excluem identidade não auditada, inferida ou "
                    + "disputada, faixa dinâmica inválida e versão de workload indeterminável; "
                    + "eles informam quantos resultados foram excluídos por cada motivo.";
