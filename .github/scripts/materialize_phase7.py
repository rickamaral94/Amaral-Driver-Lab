...
PARTS = [
    ...
    ("part-03.b64", "53733597abd8b4140fbb6581ec1ebfda6224f21128411472549a622ff36ca08d"),
...
try:
    ...
    raise SystemExit(f"Invalid Phase 7 base64: {error}") from error
...
try:
    ...
    raise SystemExit(f"Invalid Phase 7 gzip: {error}") from error
...
print(
    "Materialized Phase 7 full qualification "
    f"({len(patch)} patch bytes, gzip {EXPECTED_GZIP_SHA256})"
)
